...
// IBuilderModuleCoin is an auto generated low-level Go binding around an user-defined struct.
type IBuilderModuleCoin struct {
	Amount uint64
	Denom  string
}
...
var BuilderModuleMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"bidder\",\"type\":\"string\"},{\"components\":[{\"internalType\":\"uint64\",\"name\":\"amount\",\"type\":\"uint64\"},{\"internalType\":\"string\",\"name\":\"denom\",\"type\":\"string\"}],\"internalType\":\"structIBuilderModule.Coin\",\"name\":\"amount\",\"type\":\"tuple\"},{\"internalType\":\"bytes\",\"name\":\"txBytes\",\"type\":\"bytes\"}],\"name\":\"auctionBid\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"payable\",\"type\":\"function\"}]",
}
...
// AuctionBid is a paid mutator transaction binding the contract method 0xa4b49da6.
//
// Solidity: function auctionBid(string bidder, (uint64,string) amount, bytes txBytes) payable returns(bool)
func (_BuilderModule *BuilderModuleTransactor) AuctionBid(opts *bind.TransactOpts, bidder string, amount IBuilderModuleCoin, txBytes []byte) (*types.Transaction, error) {
	return _BuilderModule.contract.Transact(opts, "auctionBid", bidder, amount, txBytes)
}

// AuctionBid is a paid mutator transaction binding the contract method 0xa4b49da6.
//
// Solidity: function auctionBid(string bidder, (uint64,string) amount, bytes txBytes) payable returns(bool)
func (_BuilderModule *BuilderModuleSession) AuctionBid(bidder string, amount IBuilderModuleCoin, txBytes []byte) (*types.Transaction, error) {
	return _BuilderModule.Contract.AuctionBid(&_BuilderModule.TransactOpts, bidder, amount, txBytes)
}

// AuctionBid is a paid mutator transaction binding the contract method 0xa4b49da6.
//
// Solidity: function auctionBid(string bidder, (uint64,string) amount, bytes txBytes) payable returns(bool)
func (_BuilderModule *BuilderModuleTransactorSession) AuctionBid(bidder string, amount IBuilderModuleCoin, txBytes []byte) (*types.Transaction, error) {
	return _BuilderModule.Contract.AuctionBid(&_BuilderModule.TransactOpts, bidder, amount, txBytes)
}
