...
replace github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20230516070302-88564f8af320
...
require (
	...
	pkg.berachain.dev/polaris/lib v0.0.0-20230313214926-47d6f56b8f0d // indirect
)
