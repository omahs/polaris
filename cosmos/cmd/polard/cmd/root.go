...
func NewRootCmd() *cobra.Command {
	var (
		...
		mempool            = evmmepool.NewPolarisEthereumTxPool()
	)

	if err := depinject.Inject(depinject.Configs(simapp.AppConfig,
		depinject.Supply(mempool, log.NewNopLogger())),
		&interfaceRegistry,
		&appCodec,
		&txConfig,
		&legacyAmino,
